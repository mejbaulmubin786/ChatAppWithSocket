                        ...
                        >
                            ...
                            <div class="header-notifications-list">
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="notify bg-light-success text-success"
                                        >
                                            <i
                                                class="bx bx-file"
                                            ></i>
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="notify bg-light-warning text-warning"
                                        >
                                            <i
                                                class="bx bx-send"
                                            ></i>
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="notify bg-light-info text-info"
                                        >
                                            <i
                            ...
                            <div class="header-message-list">
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-2.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-3.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-4.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-5.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-6.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-7.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-8.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-9.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-10.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="user-online">
                                            <img
                                                src="{{asset('adminbackend/assets/images/avatars/avatar-11.png')}}"
                                                class="msg-avatar"
                                                alt="user avatar"
                                            />
                                        </div>
